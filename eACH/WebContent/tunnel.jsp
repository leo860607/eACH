		  			...
		  			<tr>
		  				<td colspan="2">
		  					<select onchange="$('#userId').val(this.value)">
								...
								<option value="0040000-A1">0040000-A1</option>
		  						<option value="0188888-01">0188888-01</option>
								<option value="4210000-01">4210000-01</option>
								<option value="4210000-A1">4210000-A1</option>
		  						...
		  						<option value="1307775-01">1307775-01</option>
		  					</select>
		  				</td>
		  			</tr>
