...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/transactiondetail_download">
						...
						<table id="search_tab">
							...
							<logic:equal name="userData" property="USER_TYPE" value="A">
								<tr>															
									...
									<td>
										<html:select styleId="OPBK_ID" property="OPBK_ID">
											<html:optionsCollection name="transactiondetail_download_form" property="opbkIdList" label="label" value="value"></html:optionsCollection>
										</html:select>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="header"></td>
									<td  style="border: 1px dashed navy; padding: 0.5em">
											 <b>※&nbsp;額外說明</b>：
											不含整批發動
									</td>
								</tr>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function init(){
				alterMsg();
				setDatePicker();
				$("#BIZDATE").val('<bean:write name="transactiondetail_download_form" property="BIZDATE"/>');
				$("#formID").validationEngine({binded:false,promptPosition: "bottomLeft"});
			}
			
			function alterMsg(){
 				var msg = '<bean:write name="transactiondetail_download_form" property="msg"/>';
