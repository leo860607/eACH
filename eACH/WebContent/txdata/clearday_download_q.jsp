...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/clearday_download">
...
<%-- 											<html:option value="all">全部</html:option> --%>
											<logic:present name="clearday_download_form" property="opbkIdList">
												<html:optionsCollection name="clearday_download_form" property="opbkIdList" label="label" value="value"></html:optionsCollection>
											</logic:present>
										</html:select>
									</td>
							</tr>	
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function init(){
				alterMsg();
				setDatePicker();
				$("#BIZDATE").val('<bean:write name="clearday_download_form" property="BIZDATE"/>');
				$("#formID").validationEngine({binded:false,promptPosition: "bottomLeft"});
			}
			
			function alterMsg(){
				var msg = '<bean:write name="clearday_download_form" property="msg"/>';
