...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/agent_dl_fee002">
					...
					<fieldset>
						...
						<table id="search_tab">
							<tr>
								...
								<td style="width: 90%">
									<html:text styleId="YYYYMM" property="YYYYMM" size="7" maxlength="7" styleClass="validate[required,maxSize[7],minSize[7],funcCall[checkFEEYM]]"></html:text>
								</td>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function init(){
				alterMsg();
				$("#YYYYMM").val('<bean:write name="rpt_agent_form" property="YYYYMM"/>');
