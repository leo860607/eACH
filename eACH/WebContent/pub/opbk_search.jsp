	...
	<body onload="">
			...
			<div id="opPanel">
				<html:form action="/bank_group">
					...
					<fieldset>
						...
						<table width="100%">
							<tr>
								<td width="100px">操作行代號</td>
								<td>
									<html:select styleId="OPBK_ID" property="OPBK_ID" >
										<html:option value="none">==請選擇操作行代號==</html:option>
										<html:optionsCollection name="bank_group_form" property="opbkIdList" label="label" value="value"/>
									</html:select>
								</td>
							</tr>
							<tr>
		...
		<script type="text/javascript">
			...
			function onPut(str){
				...
				if($("#OPBK_ID").find(":selected").val() != "none"){
