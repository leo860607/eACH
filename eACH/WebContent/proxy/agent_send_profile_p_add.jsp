...
<%-- 						<html:text styleId="COMPANY_ID" property="COMPANY_ID" size="15" maxlength="10"  styleClass="validate[required,maxSize[10],notChinese,onlyNumberSp] text-input"></html:text> --%>
					...
					<tr>
						...
						<td>
							<html:text styleId="SND_COMPANY_ID" property="SND_COMPANY_ID" size="15" maxlength="10" onkeyup="checkCOMPANY_ID()" onchange="checkCOMPANY_ID()" styleClass="validate[required,maxSize[10],notChinese,onlyNumberSp] text-input"></html:text>
						</td>
					</tr>
					<tr>
						<td class="header necessary" ><span>發動者名稱</span></td>
						<td>
							<html:text styleId="SND_COMPANY_NAME" property="SND_COMPANY_NAME" size="40" maxlength="40" readonly="true" styleClass="lock validate[required] text-input" ></html:text>
						</td>
					</tr>
					<tr>
						<td class="header necessary">
