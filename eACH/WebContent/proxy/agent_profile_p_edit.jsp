			...
			<div id="dataInputTable">
				<table>
					<tr>
						...
						<td><html:text styleId="COMPANY_ID" property="COMPANY_ID" size="15" maxlength="10" onkeyup="checkCOMPANY_ID()" onchange="checkCOMPANY_ID()" styleClass="lock validate[required,maxSize[10],notChinese,onlyNumberSp] text-input" readonly="true"></html:text></td>
					</tr>
					<tr>
