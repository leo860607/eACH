				...
				<html:form styleId="formID" action="/agent_cr_line" method="POST">
					...
					<table>
						<tr>
							...
							<td>
								<html:text styleId="SND_COMPANY_ID" property="SND_COMPANY_ID" size="12" maxlength="10" onkeyup="checkCOMPANY_ID()" onchange="checkCOMPANY_ID()" styleClass="validate[required ,maxSize[10],notChinese ,onlyNumberSp] text-input"></html:text>
							</td>
						</tr>
						<tr>
