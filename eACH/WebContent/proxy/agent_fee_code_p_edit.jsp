			...
			<div id="dataInputTable">
				<table>
					...
					<tr>
						...
						<td>
							<html:text styleId="FEE_ID" property="FEE_ID" size="3" maxlength="3" readonly="true" styleClass="lock validate[required,required,maxSize[3]]"></html:text>
						</td>
					</tr>
					<tr>
						<td class="header necessary">
						...
						<td>
							<html:text styleId="START_DATE" property="START_DATE" size="8" maxlength="8" readonly="true" styleClass="lock validate[required,maxSize[8],minSize[8],twDate,notChinese] text-input "></html:text>
						</td>
					</tr>
					<tr>
						<td class="header necessary">
