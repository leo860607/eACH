			...
			<div id="dataInputTable">
				<table>
					<tr>
						...
						<td style="width: 20%"><html:text styleId="PI_COMPANY_ID" property="PI_COMPANY_ID" size="15" maxlength="10" styleClass="validate[required,maxSize[10],custom[onlyLetterNumber],notChinese] text-input" onblur="getCompanyData(this.value)"></html:text></td>
					...
					<tr>
						...
						<td><html:text  styleClass="validate[required,funcCall[checkCompanyAbbr]]" styleId="PI_COMPANY_ABBR_NAME" property="PI_COMPANY_ABBR_NAME" size="10" maxlength="20"></html:text></td>
					...
					<tr>
						...
						<td><html:text styleId="PI_COMPANY_NAME" property="PI_COMPANY_NAME" size="60" maxlength="66"  styleClass="validate[required] text-input"></html:text></td>
...
<jsp:include page="/footer.jsp"></jsp:include>
	...
	<script type="text/javascript">
		...
		function getCompanyData(companyId){
			fstop.getServerDataEx(uri + "?component=pi_company_profile_bo&method=getCompanyDataByCompanyId&PI_COMPANY_ID=" + companyId, null, false, function(data){
		...
		function checkCompanyAbbr(){
			var abbr_name = $("#PI_COMPANY_ABBR_NAME").val();
			if(abbr_name.match(/.*[^\u0000-\u007F]+.*/)){
