			...
			<html:form styleId="formID" action="/wo_company_profile" method="POST" >
				...
				<div id="dataInputTable">
					<table>
						...
						<td style="width: 22%"><html:text styleId="WO_COMPANY_ID" property="WO_COMPANY_ID" size="15" maxlength="10" readonly="true" styleClass="lock validate[required,maxSize[10],custom[onlyLetterNumber],notChinese] text-input" onblur="getCompanyData(this.value)"></html:text></td>
...
<%-- 						<td><html:text readonly="true" styleClass="lock validate[required]" styleId="COMPANY_ABBR_NAME" property="COMPANY_ABBR_NAME" size="10" maxlength="20"></html:text></td> --%>
...
<%-- 						<td colspan="3"><html:text styleId="COMPANY_NAME" property="COMPANY_NAME" size="20" maxlength="20" readonly="true" styleClass="lock validate[required] text-input"></html:text></td> --%>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><html:text styleId="START_DATE" property="START_DATE" size="10" maxlength="8" styleClass="required,validate[maxSize[8],minSize[8],twDate,notChinese,twPast[#STOP_DATE]] text-input datepicker"></html:text></td>
