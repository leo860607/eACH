...
<div id="block_body">
			...
			<div id="dataInputTable">
				<html:form styleId="formID" action="/txn_err_code" method="POST">
					...
					<table>
						<tr>
							<td class="header necessary" style="width: 40%"><span>回應代碼</span></td>
							<td><html:text styleId="ERROR_ID" property="ERROR_ID" size="4" maxlength="4" styleClass="validate[required,notChinese] text-input"></html:text></td>
						</tr>
						<tr>
							<td class="header necessary"><span>錯誤說明</span></td>
							<td><html:text property="ERR_DESC" size="66" maxlength="66" styleClass="validate[required]"></html:text></td>
						</tr>
						<tr>
							<td class="header" ><span>整批退件理由代號</span></td>
							<td><html:text styleId="BATCH_ERR_ID" property="BATCH_ERR_ID"   size="2" maxlength="2" styleClass="validate[maxSize[2],notChinese] text-input"></html:text></td>
						</tr>
						<tr>
