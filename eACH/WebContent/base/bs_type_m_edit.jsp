...
<div id="block_body">
			...
			<div id="dataInputTable">
				<html:form styleId="formID" action="/business_type" method="POST">
					...
					<table>
						<tr>
							<td class="header necessary" style="width: 50%"><span>業務類別代號</span></td>
							<td><html:text styleClass="lock" styleId="BUSINESS_TYPE_ID" property="BUSINESS_TYPE_ID" disabled="true" size="4" maxlength="4"></html:text></td>
						</tr>
						<tr>
							<td class="header necessary"><span>業務類別名稱</span></td>
							<td><html:text styleId="BUSINESS_TYPE_NAME" property="BUSINESS_TYPE_NAME" size="10" maxlength="6" styleClass="validate[required]"></html:text></td>
						</tr>
						<tr align="center">
							<td colspan="4">
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function onPut(str){
				...
				$("#BUSINESS_TYPE_ID").attr('disabled', false);
				$("form").submit();
			}	
			function init(){
				$("#BUSINESS_TYPE_ID").attr('disabled', true);
				alterMsg();
			}
			function alterMsg(){
