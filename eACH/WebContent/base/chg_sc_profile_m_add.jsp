			...
			<div id="dataInputTable">
				<table>
					<tr>
						...
						<td style="width: 20%"><html:text styleId="SD_ITEM_NO" property="SD_ITEM_NO" size="5" maxlength="3" styleClass="validate[required,maxSize[3],custom[onlyNumberSp],notChinese] text-input"></html:text></td>
					...
					<tr>
						...
						<td class="header necessary"><span>業者簡稱</span></td>
					...
					<tr>
						<td class="header necessary"><span>業者名稱</span></td>
