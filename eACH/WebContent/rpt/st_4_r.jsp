...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/rptst_4">
					...
					<fieldset>
						...
						<table id="search_tab">
							<tr>
								<td class="header necessary" style="width: 10%">營業月份區間</td>
<!-- 								<td style="width: 30%"> -->
...
<!-- 								</td> -->
								...
								<td>
									<html:select styleId="OPBK_ID" property="OPBK_ID" onchange="getBgbk_List_GE_M(this.value)">
										...
										<logic:present name="rptst_4_form" property="opbkIdList">
											<html:optionsCollection name="rptst_4_form" property="opbkIdList" label="label" value="value" />
										</logic:present>
									</html:select>
								</td>
							...
							<tr>
								...
								<td style="width: 300px">
									<html:select styleId="TXN_ID" property="TXN_ID">
										<html:option value="">全部</html:option>
										<html:optionsCollection name = "rptst_4_form" property="idList" label="label" value="value"/>
									</html:select>
								</td>
							</tr>
							<tr>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function init(){
				...
				$("#START_MONTH").val('<bean:write name="rptst_4_form" property="START_YEAR"/>');
				$("#START_MONTH").val('<bean:write name="rptst_4_form" property="START_MONTH"/>');
				$("#END_MONTH").val('<bean:write name="rptst_4_form" property="END_YEAR"/>');
				$("#END_MONTH").val('<bean:write name="rptst_4_form" property="END_MONTH"/>');
			}
			
			function alterMsg(){
				var msg = '<bean:write name="rptst_4_form" property="msg"/>';
				var result = '<bean:write name="rptst_4_form" property="result"/>';
