...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/rptfee_3">
						...
						<table id="search_tab">
							<logic:equal name="login_form" property="userData.USER_TYPE" value="A">
								<tr>
									...
									<td>
										<html:select styleId="OPBK_ID" property="OPBK_ID" onchange="getBgbk_List_GE_MS(this.value);">
											<html:option value="">全部</html:option>
											<logic:present name="rptfee_3_form" property="opbkIdList">
												<html:optionsCollection name="rptfee_3_form" property="opbkIdList" label="label" value="value"></html:optionsCollection>
											</logic:present>
										</html:select>
									</td>
								</tr>
...
// 				getBgbk_List($("#OPBK_ID").val());
			...
			function alterMsg(){
				var msg = '<bean:write name="rptfee_3_form" property="msg"/>';
				var result = '<bean:write name="rptfee_3_form" property="result"/>';
