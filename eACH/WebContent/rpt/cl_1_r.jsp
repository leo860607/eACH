...
<div id="block_body">
			<!-- BREADCRUMBS -->
			<div id="breadcrumb">
				<a href="#" class="has-next">報表列印</a>
				<a href="#">結算資料日報表</a>
			</div>
			<div id="opPanel">
				<html:form styleId="formID" action="/rptcl_1">
							...
							<tr>
								...
								<td>
									<html:select styleId="opt_id" property="opt_id" onchange="getBgbk_List(this.value)">
										...
										<html:optionsCollection name="rptcl_1_form" property="opt_bankList" label="label" value="value" />
									</html:select>
								</td>
								</logic:equal>
								<logic:greaterEqual name="userData" property="USER_TYPE" value="B">
									<td class="header" style="width: 100px">操作行代號</td>
									<td>
									<html:text name="rptcl_1_form" property="opt_bank" readonly="true" styleClass=" lock "></html:text>
									<html:hidden name="rptcl_1_form" property="opt_id" ></html:hidden>
									</td>
								</logic:greaterEqual>
							...
							<tr>
								...
								<td >
									<html:select styleId="BGBK_ID" property="BGBK_ID">
										<html:option  value="">全部</html:option>
										<logic:present name="rptcl_1_form" property="bgbkIdList">
											<html:optionsCollection name="rptcl_1_form" property="bgbkIdList" label="label" value="value"></html:optionsCollection>
										</logic:present>
									</html:select>
								</td>
							</tr>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		var uri = "${pageContext.request.contextPath}"+"/baseInfo";
			...
			function init(){
				alterMsg();
				setDatePickerII($("#BIZDATE"),'<bean:write name="rptcl_1_form" property="BIZDATE"/>');
				setDateOnChange($("#BIZDATE") ,getBgbk_List);
				$("#formID").validationEngine({binded:false,promptPosition: "bottomLeft"});
// 				$("#TXDT").val('<bean:write name="rptcl_1_form" property="TXDT"/>');
			}
			
			function alterMsg(){
				var msg = '<bean:write name="rptcl_1_form" property="msg"/>';
				var result = '<bean:write name="rptcl_1_form" property="result"/>';
