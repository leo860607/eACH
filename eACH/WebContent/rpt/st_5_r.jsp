...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/rptst_5">
...
<!-- 								</td> -->
								...
								<td>
									<html:select styleId="OPBK_ID" property="OPBK_ID" onchange="getBgbk_List_GE_M(this.value)">
										...
										<logic:present name="rptst_5_form" property="opbkIdList">
											<html:optionsCollection name="rptst_5_form" property="opbkIdList" label="label" value="value" />
										</logic:present>
									</html:select>
								</td>
							</tr>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function init(){
				...
				$("#START_MONTH").val('<bean:write name="rptst_5_form" property="START_YEAR"/>');
				$("#START_MONTH").val('<bean:write name="rptst_5_form" property="START_MONTH"/>');
				$("#END_MONTH").val('<bean:write name="rptst_5_form" property="END_YEAR"/>');
				$("#END_MONTH").val('<bean:write name="rptst_5_form" property="END_MONTH"/>');
			}
			
			function alterMsg(){
				var msg = '<bean:write name="rptst_5_form" property="msg"/>';
				var result = '<bean:write name="rptst_5_form" property="result"/>';
