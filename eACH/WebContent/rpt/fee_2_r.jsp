...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/rptfee_2">
								...
								<tr>
									...
									<td>
										<html:select styleId="OPBK_ID" property="OPBK_ID" onchange="getBgbk_List_GE_MS(this.value);getBrbk_List($('#BGBK_ID').val())">
											...
											<logic:present name="rptfee_2_form" property="opbkIdList">
												<html:optionsCollection name="rptfee_2_form" property="opbkIdList" label="label" value="value"></html:optionsCollection>
											</logic:present>
										</html:select>
									</td>
								</tr>
...
// 				getBgbk_List($("#OPBK_ID").val());
			...
			function alterMsg(){
				var msg = '<bean:write name="rptfee_2_form" property="msg"/>';
				var result = '<bean:write name="rptfee_2_form" property="result"/>';
