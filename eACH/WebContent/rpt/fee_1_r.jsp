...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/rptfee_1">
					<html:hidden property="ac_key" styleId="ac_key" value=""/>
					<html:hidden property="target" styleId="target" value=""/>
					<html:hidden property="dow_token" styleId="dow_token"/>
					<html:hidden property="userCompany" styleId="userCompany"/>
							...
							<logic:equal name="userData" property="USER_TYPE" value="A">
								<tr>
									...
									<td style="width: 30%">
										...
										<html:text styleId="END_DATE" property="END_DATE" size="8" maxlength="8" styleClass="validate[required,maxSize[8],minSize[8],twDate ,twFuture[#START_DATE]] text-input datepicker"></html:text>
									</td>
								...
								<tr>
									<td class="header" style="width: 16%">操作行</td>
									<td style="width: 30%">
										<html:select styleId="OPBK_ID" property="OPBK_ID" onchange="getBgbk_List(this.value);getBrbk_List($('#BGBK_ID').val())">
											<html:option value="">全部</html:option>
											<html:optionsCollection name="rptfee_1_form" property="opbkIdList" label="label" value="value"></html:optionsCollection>
										</html:select>
									</td>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function init(){
				...
				*/
				$("#START_DATE").val('<bean:write name="rptfee_1_form" property="START_DATE"/>');
				$("#END_DATE").val('<bean:write name="rptfee_1_form" property="START_DATE"/>');
				
				getBgbk_List($("#OPBK_ID").val());
			}
			
			function alterMsg(){
				var msg = '<bean:write name="rptfee_1_form" property="msg"/>';
				var result = '<bean:write name="rptfee_1_form" property="result"/>';
