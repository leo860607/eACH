...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/rptst_15">
							...
							<tr>
								...
								<td>
									<html:select styleId="BUSINESS_TYPE_ID" property="BUSINESS_TYPE_ID">
										...
										<logic:present name="rptst_15_form" property="pcodeList">
											<html:optionsCollection name="rptst_15_form" property="pcodeList" label="label" value="value"></html:optionsCollection>
										</logic:present>
									</html:select>
								</td>
							</tr>
							<tr>
								...
								<td>
									<html:select styleId="OPBK_ID" property="OPBK_ID">
										<html:option value="all">全部</html:option>
										<logic:present name="rptst_15_form" property="opbkIdList">
											<html:optionsCollection name="rptst_15_form" property="opbkIdList" label="label" value="value"></html:optionsCollection>
										</logic:present>
									</html:select>
								</td>
								<td class="header">&nbsp;</td>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function init(){
				...
				$("[id^=TXDATE]").val('<bean:write name="rptst_15_form" property="TXDATE"/>');
				$("#formID").validationEngine({binded:false,promptPosition: "bottomLeft"});
			}
			
			function alterMsg(){
				var msg = '<bean:write name="rptst_15_form" property="msg"/>';
				var result = '<bean:write name="rptst_15_form" property="result"/>';
