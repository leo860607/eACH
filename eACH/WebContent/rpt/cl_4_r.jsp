...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/rptcl_4">
...
<!-- 								<input type="radio" name = "r1" value="A" checked="checked" onclick="lockoth($('.ser1'),$('.ser2'))"> -->
								代理清算行</td>
								<logic:equal name="userData" property="USER_TYPE" value="A">
								<td>
									<html:select styleId="CTBK_ID" property="CTBK_ID" styleClass="ser1">
										<html:option value="">====全部====</html:option>
										<html:optionsCollection name="rptcl_4_form" property="ct_bankList" label="label" value="value" />
									</html:select>
								</td>	
								</logic:equal>	
								<logic:equal name="userData" property="USER_TYPE" value="B">
								<td>
									<html:text name="rptcl_4_form" property="CTBK_NAME" readonly="true" styleClass=" lock "></html:text>
									<html:hidden name="rptcl_4_form" property="CTBK_ID" ></html:hidden>
								</td>
								</logic:equal>						
							</tr>
							<tr>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function init(){
				alterMsg();
				setDatePickerII($("#BIZDATE"),'<bean:write name="rptcl_4_form" property="BIZDATE"/>');
				$("#formID").validationEngine({binded:false,promptPosition: "bottomLeft"});
// 				$("#TXDT").val('<bean:write name="rptcl_4_form" property="TXDT"/>');
			}
			
			function alterMsg(){
				var msg = '<bean:write name="rptcl_4_form" property="msg"/>';
				var result = '<bean:write name="rptcl_4_form" property="result"/>';
