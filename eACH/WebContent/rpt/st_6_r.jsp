...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/rptst_6">
					...
					<fieldset>
						...
						<table id="search_tab">
							<tr>
								...
								<td class="header" style="width: 100px">查詢角度</td>
								<td>
									<html:select styleId="OP_TYPE" property="OP_TYPE">
										<html:option value="S">發動行</html:option>
										<html:option value="O">扣款行</html:option>
										<html:option value="I">入帳行</html:option>
									</html:select>
								</td>
							</tr>
							<tr>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		<script type="text/javascript">
			...
			function init(){
				...
				$("#START_MONTH").val('<bean:write name="rptst_6_form" property="START_YEAR"/>');
				$("#START_MONTH").val('<bean:write name="rptst_6_form" property="START_MONTH"/>');
				$("#END_MONTH").val('<bean:write name="rptst_6_form" property="END_YEAR"/>');
				$("#END_MONTH").val('<bean:write name="rptst_6_form" property="END_MONTH"/>');
			}
			
			function alterMsg(){
				var msg = '<bean:write name="rptst_6_form" property="msg"/>';
				var result = '<bean:write name="rptst_6_form" property="result"/>';
