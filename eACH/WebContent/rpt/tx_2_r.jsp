...
<div id="block_body">
			...
			<div id="opPanel">
				<html:form styleId="formID" action="/rpttx_2">
					...
					<fieldset>
						...
						<table id = "search_tab">
							<tr>
								...
								<td style="width: 30%">
<%-- 									<html:text styleId="TXDT" property="TXDT" size="8" maxlength="8" styleClass="validate[ maxSize[8],minSize[8],twDate] text-input datepicker"></html:text> --%>
							...
							<logic:equal name="userData" property="USER_TYPE" value="A">
								...
								<td>
									<html:select styleId="opt_id" property="opt_id" onchange="getBgbk_List(this.value)">
										...
										<html:optionsCollection name="rpttx_2_form" property="opt_bankList" label="label" value="value" />
									</html:select>
								</td>
							</logic:equal>
							<logic:greaterEqual name="userData" property="USER_TYPE" value="B">
								<td class="header" style="width: 100px">操作行代號</td>
								<td>
								<html:text name="rpttx_2_form" property="opt_bank" readonly="true" styleClass=" lock "></html:text>
								<html:hidden name="rpttx_2_form" styleId="opt_id" property="opt_id" ></html:hidden>
<%-- 									<html:select styleId="opt_id" property="opt_id" onchange="getBgbk_List(this.value)"> --%>
<%-- 										<html:option value="">全部</html:option> --%>
<%-- 										<html:optionsCollection name="rpttx_2_form" property="opt_bankList" label="label" value="value" /> --%>
<%-- 									</html:select> --%>
							...
							<tr>
								...
								<td colspan="3">
									<html:select styleId="BGBK_ID" property="BGBK_ID">
										<html:option  value="">全部</html:option>
										<logic:present name="rpttx_2_form" property="bgbkIdList">
											<html:optionsCollection name="rpttx_2_form" property="bgbkIdList" label="label" value="value"></html:optionsCollection>
										</logic:present>
									</html:select>
								</td>
							</tr>
...
<jsp:include page="/footer.jsp"></jsp:include>
		...
		var uri = "${pageContext.request.contextPath}"+"/baseInfo";
			...
			function init(){
				alterMsg();
				setDatePickerII($("#BIZDATE"),'<bean:write name="rpttx_2_form" property="BIZDATE"/>');
				setDateOnChange($("#BIZDATE") ,getBgbk_List);
				$("#formID").validationEngine({binded:false,promptPosition: "bottomLeft"});
// 				$("#TXDT").val('<bean:write name="rpttx_2_form" property="TXDT"/>');
			}
			
			function alterMsg(){
				var msg = '<bean:write name="rpttx_2_form" property="msg"/>';
				var result = '<bean:write name="rpttx_2_form" property="result"/>';
