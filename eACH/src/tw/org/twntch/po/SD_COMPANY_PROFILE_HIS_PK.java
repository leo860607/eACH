...
public class SD_COMPANY_PROFILE_HIS_PK implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 9210145969465292071L;
	private String COMPANY_ID ;
	private String TXN_ID ;
	private String SND_BRBK_ID ;
	public SD_COMPANY_PROFILE_HIS_PK() {
	}
	public SD_COMPANY_PROFILE_HIS_PK(String cOMPANY_ID, String tXN_ID,
			String sND_BRBK_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SD_COMPANY_PROFILE_HIS_PK other = (SD_COMPANY_PROFILE_HIS_PK) obj;
		if (COMPANY_ID == null) {
