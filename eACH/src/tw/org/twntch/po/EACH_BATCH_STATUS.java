...
@Entity(name="tw.org.twntch.po.EACH_BATCH_STATUS")
@Table(name="EACH_BATCH_STATUS")
public class EACH_BATCH_STATUS implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -233145552257778211L;
	private EACH_BATCH_STATUS_PK id ;
	...
	@EmbeddedId
	public EACH_BATCH_STATUS_PK getId() {
		return id;
	}
	public void setId(EACH_BATCH_STATUS_PK id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EACH_BATCH_STATUS other = (EACH_BATCH_STATUS) obj;
		if (id == null) {
			if (other.id != null)
				return false;
