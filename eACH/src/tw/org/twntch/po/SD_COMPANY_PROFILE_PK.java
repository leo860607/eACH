...
public class SD_COMPANY_PROFILE_PK implements Serializable{
	...
	public SD_COMPANY_PROFILE_PK() {
	}
	public SD_COMPANY_PROFILE_PK(String cOMPANY_ID, String tXN_ID,
			String sND_BRBK_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SD_COMPANY_PROFILE_PK other = (SD_COMPANY_PROFILE_PK) obj;
		if (COMPANY_ID == null) {
