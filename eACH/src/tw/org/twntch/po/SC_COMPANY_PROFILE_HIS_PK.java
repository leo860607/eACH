...
public class SC_COMPANY_PROFILE_HIS_PK implements Serializable{
	...
	public SC_COMPANY_PROFILE_HIS_PK() {
	}
	public SC_COMPANY_PROFILE_HIS_PK(String cOMPANY_ID, String tXN_ID,
			String sND_BRBK_ID) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SC_COMPANY_PROFILE_HIS_PK other = (SC_COMPANY_PROFILE_HIS_PK) obj;
		if (COMPANY_ID == null) {
