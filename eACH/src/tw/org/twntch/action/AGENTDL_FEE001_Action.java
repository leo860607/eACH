...
public class AGENTDL_FEE001_Action extends GenericAction{
...
//			參加單位端代入登入時的單位ID
		...
		if(ac_key.equalsIgnoreCase("download")){
			...
			try{
				...
				Map<String,String> valueMap = codeUtils.getPropertyValue("Configuration.properties","agentDirPath","agentfee001FilePrefix");
				//無法取得properties
				if(valueMap == null){
					//回頁面alert訊息
				...
				//取得檔名的前置碼
				String filePrefix = valueMap.get("agentfee001FilePrefix");
...
//				//先去完整路徑抓檔案
				...
				Map<String,Object> dataMap = agentdl_fee001_bo.getTXT(date,agent_company_id,snd_company_id,clearingphase,true);
				//正常
