...
import tw.org.twntch.bo.RPTST_11_BO;
...
public class RPTST_11_Action extends GenericAction {

		private RPTST_11_BO rptst_11_bo ;
		@Override
		public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			String  yyyymm = "" , outFilename = "_st_11.pdf";
			Map map = null ;
			int export_type = 1;
			System.out.println("RPTST_11_Action is start >> " + ac_key);
			...
			if(ac_key.equalsIgnoreCase("search") || ac_key.equalsIgnoreCase("xls") ){
				...
				if(ac_key.equalsIgnoreCase("xls")){
					export_type = 2;
					outFilename = "_st_11.xls";
					map = rptst_11_bo.ex_export(rpt_form.getOPBK_ID(), yyyymm , rpt_form.getCLEARINGPHASE(), rpt_form.getSerchStrs() , export_type );
				}else{
					map = rptst_11_bo.export(rpt_form.getOPBK_ID(), yyyymm , rpt_form.getCLEARINGPHASE(), rpt_form.getSerchStrs() , export_type );
				}
			...
			if(StrUtils.isEmpty(ac_key)){
				String bsDate = rptst_11_bo.getBank_group_bo().getEachsysstatustab_bo().getRptBusinessDate();
//				20160118 edit by hugo req by UAT-20160112-01..~05
			...
			rpt_form.setOpbkIdList(rptst_11_bo.getBank_group_bo().getOpbkList());
		...
		public RPTST_11_BO getRptst_11_bo() {
			return rptst_11_bo;
		}


		public void setRptst_11_bo(RPTST_11_BO rptst_11_bo) {
			this.rptst_11_bo = rptst_11_bo;
		}
