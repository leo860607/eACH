...
public class FEE_CODE_NWLVL_Action extends Action{
...
//				BeanUtils.populate(fee_code_form, JSONUtils.json2map(fee_code_form.getSerchStrs()));
//			}
//			list = fee_code_nw_bo.search(fee_code_form.getFEE_ID(),fee_code_form.getSTART_DATE());
...
//			Map map = fee_code_nw_bo.delete(fee_code_form.getFEE_ID(), fee_code_form.getSTART_DATE());
//			if(map.get("result").equals("TRUE")){
//				BeanUtils.populate(fee_code_form, JSONUtils.json2map(fee_code_form.getSerchStrs()));
//			}
//			BeanUtils.populate(fee_code_form, map);
...
//		//FEE_ID下拉清單
//		//fee_code_form.setIdList(fee_code_nw_bo.getIdList());
//		fee_code_form.setIdList(fee_code_nw_bo.getIdListJoinTxnName());
