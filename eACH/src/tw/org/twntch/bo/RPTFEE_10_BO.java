...
public class RPTFEE_10_BO {
	private AGENT_SEND_PROFILE_BO agent_send_profile_bo;
	private RPONBLOCKTAB_Dao rponblocktab_Dao;
	
	public Map<String, String> ex_export(String agent_company_id, String snd_company_id,String yyyymm ,  String clearingPhase , String serchStrs , int export_type){
		return export(agent_company_id, snd_company_id, yyyymm, clearingPhase, serchStrs, export_type);
	}
	
	public Map<String, String> export(String agent_company_id, String snd_company_id,String yyyymm ,  String clearingPhase , String serchStrs , int export_type){
		Map<String, String> rtnMap = null;
		Map<String, String> serchparams = null;
		String outputFilePath = "" , conditionKey  ="" ,file_resource = "fee_10";
		try{
...
//			報表顯示區塊
			...
			file_resource = export_type == 2?"ex_fee_10":file_resource;
			outputFilePath  = RptUtils.export(RptUtils.COLLECTION,pathType, file_resource, file_resource, params, list , export_type);
			System.out.println("RPTFEE_10_BO.sql>>"+sql);
			System.out.println("RPTFEE_10_BO.map>>"+map);
