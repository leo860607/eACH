...
public class RPTFEE_4_BO {
	...
	public Map<String, String> export(String ext, String twYear, String twMonth, String opbkId, String bgbkId, String brbkId, String serchStrs){
		...
		try{
			...
			if(ext.equals("xls")){
				outputFilePath = RptUtils.export(RptUtils.COLLECTION,pathType, "ex_fee_4", "fee_4", params, list, 2);
			}else if(ext.equals("pdf")){
				outputFilePath = RptUtils.export(RptUtils.COLLECTION,pathType, "fee_4", "fee_4", params, list);
			}
