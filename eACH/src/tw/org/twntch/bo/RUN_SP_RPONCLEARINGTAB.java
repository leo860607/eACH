...
public class RUN_SP_RPONCLEARINGTAB implements Runnable{
	@Override
	public void run() {
...
//				if(zDateHandler.isInTimeRange(zDateHandler.getTheTime(), Arguments.getStringArg("RPONBLOCKTAB_CL1_A"), Arguments.getStringArg("RPONBLOCKTAB_CL1_B"))){
				if(zDateHandler.isInTimeRange(zDateHandler.getTheTime(), SYS.RPONBLOCKTAB_CL1_A, SYS.RPONBLOCKTAB_CL1_B)){
					System.out.println("RUN_SP_RPONCLEARINGTAB ..時間區間內開始..");
